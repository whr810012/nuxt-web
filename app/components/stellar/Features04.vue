    ...
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div class="pt-16 pb-12 md:pt-32 md:pb-20">
        ...
        <div class="max-w-3xl pb-12 md:pb-20">
          ...
          <p class="text-lg text-slate-400">{{$t('app/components/stellar/Features04.vue:Many desktop publishing packages and web page editors now use lorem ipsum as their default model text, and a search will uncover many web sites still in their infancy.')}}</p>
        </div>
        ...
        <div class="divide-y divide-slate-800">
          ...
          <div class="py-8 first-of-type:pt-0 last-of-type:pb-0">
            <div>
              <div class="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-6">{{$t('app/components/stellar/Features04.vue:API Authorization')}}</div>
            </div>
            <div class="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
              ...
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{$t('app/components/stellar/Features04.vue:Discussions')}}</h4>
                </div>
                <p class="text-sm text-slate-400">{{$t('app/components/stellar/Features04.vue:Login box must find the right balance for the user convenience, privacy and security.')}}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{$t('app/components/stellar/Features04.vue:Team views')}}</h4>
                </div>
                <p class="text-sm text-slate-400">{{$t('app/components/stellar/Features04.vue:Login box must find the right balance for the user convenience, privacy and security.')}}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{$t('app/components/stellar/Features04.vue:Powerful search')}}</h4>
                </div>
                <p class="text-sm text-slate-400">{{$t('app/components/stellar/Features04.vue:Login box must find the right balance for the user convenience, privacy and security.')}}</p>
              </div>
            </div>
          ...
          <div class="py-8">
            <div>
              <div class="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-6">{{$t('app/components/stellar/Features04.vue:User Management')}}</div>
            </div>
            <div class="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{$t('app/components/stellar/Features04.vue:Analytics')}}</h4>
                </div>
                <p class="text-sm text-slate-400">{{$t('app/components/stellar/Features04.vue:Login box must find the right balance for the user convenience, privacy and security.')}}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{$t('app/components/stellar/Features04.vue:Notifications')}}</h4>
                </div>
                <p class="text-sm text-slate-400">{{$t('app/components/stellar/Features04.vue:Login box must find the right balance for the user convenience, privacy and security.')}}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{$t('app/components/stellar/Features04.vue:Integrations')}}</h4>
                </div>
                <p class="text-sm text-slate-400">{{$t('app/components/stellar/Features04.vue:Login box must find the right balance for the user convenience, privacy and security.')}}</p>
              </div>
            </div>
          ...
          <div class="py-8">
            <div>
              <div class="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-6">{{$t('app/components/stellar/Features04.vue:Standard Security')}}</div>
            </div>
            <div class="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{$t('app/components/stellar/Features04.vue:Privacy')}}</h4>
                </div>
                <p class="text-sm text-slate-400">{{$t('app/components/stellar/Features04.vue:Login box must find the right balance for the user convenience, privacy and security.')}}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{$t('app/components/stellar/Features04.vue:Data export')}}</h4>
                </div>
                <p class="text-sm text-slate-400">{{$t('app/components/stellar/Features04.vue:Login box must find the right balance for the user convenience, privacy and security.')}}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{$t('app/components/stellar/Features04.vue:Real-time sync')}}</h4>
                </div>
                <p class="text-sm text-slate-400">{{$t('app/components/stellar/Features04.vue:Login box must find the right balance for the user convenience, privacy and security.')}}</p>
              </div>
            </div>
