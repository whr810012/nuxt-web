    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-32 pb-10 md:pt-40">
        ...
        <div class="text-center">
          <div class="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-3">{{$t('app/components/stellar/HeroAbout.vue:The folks behind the product')}}</div>
          <h1 class="h1 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-6">{{$t('app/components/stellar/HeroAbout.vue:Turning security into innovation')}}</h1>
          <!-- Rings illustration -->
          <div class="inline-flex items-center justify-center relative">
            ...
            <div class="inline-flex [mask-image:_radial-gradient(circle_at_bottom,transparent_15%,black_70%)]">
              <img src="@/assets/images/about-illustration.svg" width="446" height="446" alt="About illustration" />
            </div>
            <img class="absolute mt-[30%] drop-shadow-lg animate-float" src="@/assets/images/about-icon.svg" width="72" height="72" alt="About icon" />
          </div>
        </div>
