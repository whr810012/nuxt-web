    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-16 md:pt-32">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <h2 class="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">{{ t('features02.header.title') }}</h2>
          <p class="text-lg text-slate-400">{{ t('features02.header.description') }}</p>
        </div>
                ...
                <div class="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                  <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    ...
                    <div class="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8 md:pr-0">
                      <div class="mb-5">
                        <div>
                          <h3 class="inline-flex text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">{{ t('features02.box1.title') }}</h3>
                          <p class="text-slate-400">{{ t('features02.box1.description') }}</p>
                        </div>
                      </div>
                      <div>
                        <a class="btn-sm text-slate-300 hover:text-white transition duration-150 ease-in-out group [background:linear-gradient(var(--color-slate-900),var(--color-slate-900))_padding-box,conic-gradient(var(--color-slate-400),var(--color-slate-700)_25%,var(--color-slate-700)_75%,var(--color-slate-400)_100%)_border-box] relative before:absolute before:inset-0 before:bg-slate-800/30 before:rounded-full before:pointer-events-none" href="#0">
                          <span class="relative inline-flex items-center">
                            {{ t('common.learnMore') }} <span class="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span>
                          </span>
                        </a>
                      </div>
                    </div>
                ...
                <div class="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                  <div class="flex flex-col">
                    ...
                    <div class="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                      <div>
                        <h3 class="inline-flex text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">{{ t('features02.box2.title') }}</h3>
                        <p class="text-slate-400">{{ t('features02.box2.description') }}</p>
                      </div>
                    </div>
                    <!-- Image -->
              ...
              <HighlighterItem>
                <div class="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                  <div class="flex flex-col">
                    ...
                    <div class="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                      <div>
                        <h3 class="inline-flex text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">{{ t('features02.box3.title') }}</h3>
                        <p class="text-slate-400">{{ t('features02.box3.description') }}</p>
                      </div>
                    </div>
                    <!-- Image -->
                    <div class="relative w-full h-64 md:h-auto overflow-hidden md:pb-8">
        ...
        <div class="grid md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">{{ t('features02.features.feature1.title') }}</h4>
            </div>
            <p class="text-sm text-slate-400">{{ t('features02.features.feature1.description') }}</p>
          </div>
          <!-- Feature -->
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">{{ t('features02.features.feature2.title') }}</h4>
            </div>
            <p class="text-sm text-slate-400">{{ t('features02.features.feature2.description') }}</p>
          </div>
          <!-- Feature -->
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">{{ t('features02.features.feature3.title') }}</h4>
            </div>
            <p class="text-sm text-slate-400">{{ t('features02.features.feature3.description') }}</p>
          </div>
          <!-- Feature -->
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">{{ t('features02.features.feature4.title') }}</h4>
            </div>
            <p class="text-sm text-slate-400">{{ t('features02.features.feature4.description') }}</p>
          </div>
          <!-- Feature -->
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">{{ t('features02.features.feature5.title') }}</h4>
            </div>
            <p class="text-sm text-slate-400">{{ t('features02.features.feature5.description') }}</p>
          </div>
          <!-- Feature -->
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">{{ t('features02.features.feature6.title') }}</h4>
            </div>
            <p class="text-sm text-slate-400">{{ t('features02.features.feature6.description') }}</p>
          </div>
        </div>
