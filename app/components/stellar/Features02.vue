    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pt-16 md:pt-32">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-20">
          <h2 class="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">{{$t('app/components/stellar/Features02.vue:Faster. Smarter.')}}</h2>
          <p class="text-lg text-slate-400">{{$t('app/components/stellar/Features02.vue:There are many variations available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.')}}</p>
        </div>
                ...
                <div class="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                  <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    ...
                    <div class="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8 md:pr-0">
                      <div class="mb-5">
                        <div>
                          <h3 class="inline-flex text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">{{$t('app/components/stellar/Features02.vue:Optimized for security')}}</h3>
                          <p class="text-slate-400">{{$t('app/components/stellar/Features02.vue:Optimize for user experience and privacy. Use social login integrations, lower user friction, incorporate rich user profiling, and facilitate more transactions.')}}</p>
                        </div>
                      </div>
                      <div>
                        <a class="btn-sm text-slate-300 hover:text-white transition duration-150 ease-in-out group [background:linear-gradient(var(--color-slate-900),var(--color-slate-900))_padding-box,conic-gradient(var(--color-slate-400),var(--color-slate-700)_25%,var(--color-slate-700)_75%,var(--color-slate-400)_100%)_border-box] relative before:absolute before:inset-0 before:bg-slate-800/30 before:rounded-full before:pointer-events-none" href="#0">
                          <span class="relative inline-flex items-center">
                            Learn more <span class="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">{{$t('app/components/stellar/Features02.vue:-&gt;')}}</span>
                          </span>
                        </a>
                      </div>
                    </div>
                    ...
                    <div class="relative w-full h-64 md:h-auto overflow-hidden">
                      <img class="absolute bottom-0 left-1/2 -translate-x-1/2 mx-auto max-w-none md:relative md:left-0 md:translate-x-0" src="@/assets/images/feature-image-01.png" width="504" height="400" alt="Feature 01">
                    </div>
                  </div>
                </div>
              </HighlighterItem>
                ...
                <div class="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                  <div class="flex flex-col">
                    ...
                    <div class="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                      <div>
                        <h3 class="inline-flex text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">{{$t('app/components/stellar/Features02.vue:Extensibility')}}</h3>
                        <p class="text-slate-400">{{$t('app/components/stellar/Features02.vue:Your login box must find the right balance between user convenience, privacy and security.')}}</p>
                      </div>
                    </div>
                    <!-- Image -->
                    <div class="relative w-full h-64 md:h-auto overflow-hidden md:pb-8">
                      <img class="absolute bottom-0 left-1/2 -translate-x-1/2 mx-auto max-w-none md:max-w-full md:relative md:left-0 md:translate-x-0" src="@/assets/images/feature-image-02.png" width="536" height="230" alt="Feature 02">
                    </div>
                  </div>
                </div>
              </HighlighterItem>
              ...
              <HighlighterItem>
                <div class="relative h-full bg-slate-900 rounded-[inherit] z-20 overflow-hidden">
                  <div class="flex flex-col">
                    ...
                    <div class="md:max-w-[480px] shrink-0 order-1 md:order-none p-6 pt-0 md:p-8">
                      <div>
                        <h3 class="inline-flex text-xl font-bold bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-1">{{$t('app/components/stellar/Features02.vue:Infinite options')}}</h3>
                        <p class="text-slate-400">{{$t('app/components/stellar/Features02.vue:Quickly apply filters to refine your issues lists and create custom views.')}}</p>
                      </div>
                    </div>
                    <!-- Image -->
                    <div class="relative w-full h-64 md:h-auto overflow-hidden md:pb-8">
                      <img class="absolute bottom-0 left-1/2 -translate-x-1/2 mx-auto max-w-none md:max-w-full md:relative md:left-0 md:translate-x-0" src="@/assets/images/feature-image-03.png" width="230" height="230" alt="Feature 03">
                    </div>
                  </div>
                </div>
              </HighlighterItem>
        ...
        <div class="grid md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">{{$t('app/components/stellar/Features02.vue:Filters')}}</h4>
            </div>
            <p class="text-sm text-slate-400">{{$t('app/components/stellar/Features02.vue:Login box must find the right balance for the user convenience, privacy and security.')}}</p>
          </div>
          <!-- Feature -->
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">{{$t('app/components/stellar/Features02.vue:Configurable')}}</h4>
            </div>
            <p class="text-sm text-slate-400">{{$t('app/components/stellar/Features02.vue:Login box must find the right balance for the user convenience, privacy and security.')}}</p>
          </div>
          <!-- Feature -->
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">{{$t('app/components/stellar/Features02.vue:Adaptable')}}</h4>
            </div>
            <p class="text-sm text-slate-400">{{$t('app/components/stellar/Features02.vue:Login box must find the right balance for the user convenience, privacy and security.')}}</p>
          </div>
          <!-- Feature -->
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">{{$t('app/components/stellar/Features02.vue:Authorization')}}</h4>
            </div>
            <p class="text-sm text-slate-400">{{$t('app/components/stellar/Features02.vue:Login box must find the right balance for the user convenience, privacy and security.')}}</p>
          </div>
          <!-- Feature -->
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">{{$t('app/components/stellar/Features02.vue:Management')}}</h4>
            </div>
            <p class="text-sm text-slate-400">{{$t('app/components/stellar/Features02.vue:Login box must find the right balance for the user convenience, privacy and security.')}}</p>
          </div>
          <!-- Feature -->
          <div>
            <div class="flex items-center space-x-2 mb-1">
              ...
              <h4 class="font-medium text-slate-50">{{$t('app/components/stellar/Features02.vue:Building')}}</h4>
            </div>
            <p class="text-sm text-slate-400">{{$t('app/components/stellar/Features02.vue:Login box must find the right balance for the user convenience, privacy and security.')}}</p>
          </div>
        </div>
