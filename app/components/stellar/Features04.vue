    ...
    <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div class="pt-16 pb-12 md:pt-32 md:pb-20">
        ...
        <div class="max-w-3xl pb-12 md:pb-20">
          <h2 class="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">{{ $t('features04.title') }}</h2>
          <p class="text-lg text-slate-400">{{ $t('features04.description') }}</p>
        </div>
        ...
        <div class="divide-y divide-slate-800">
          ...
          <div class="py-8 first-of-type:pt-0 last-of-type:pb-0">
            <div>
              <div class="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-6">{{ $t('features04.row1.title') }}</div>
            </div>
            <div class="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
              ...
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t('features04.row1.feature1.title') }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t('features04.row1.feature1.description') }}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t('features04.row1.feature2.title') }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t('features04.row1.feature2.description') }}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t('features04.row1.feature3.title') }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t('features04.row1.feature3.description') }}</p>
              </div>
            </div>
          </div>
          <!-- Row -->
          <div class="py-8">
            <div>
              <div class="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-6">{{ $t('features04.row2.title') }}</div>
            </div>
            <div class="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t('features04.row2.feature1.title') }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t('features04.row2.feature1.description') }}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t('features04.row2.feature2.title') }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t('features04.row2.feature2.description') }}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t('features04.row2.feature3.title') }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t('features04.row2.feature3.description') }}</p>
              </div>
            </div>
          </div>
          <!-- Row -->
          <div class="py-8">
            <div>
              <div class="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-6">{{ $t('features04.row3.title') }}</div>
            </div>
            <div class="grid md:grid-cols-3 gap-8 md:gap-12 mb-2">
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t('features04.row3.feature1.title') }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t('features04.row3.feature1.description') }}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t('features04.row3.feature2.title') }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t('features04.row3.feature2.description') }}</p>
              </div>
              <!-- Feature -->
              <div>
                <div class="flex items-center space-x-2 mb-1">
                  ...
                  <h4 class="font-medium text-slate-50">{{ $t('features04.row3.feature3.title') }}</h4>
                </div>
                <p class="text-sm text-slate-400">{{ $t('features04.row3.feature3.description') }}</p>
              </div>
            </div>
          </div>
        </div>
