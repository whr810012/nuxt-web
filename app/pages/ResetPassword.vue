      ...
      <div class="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div class="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div class="max-w-3xl mx-auto text-center pb-12">
            ...
            <!-- Page title -->
            <h1 class="h2 bg-clip-text text-transparent bg-linear-to-r from-slate-200/60 via-slate-200 to-slate-200/60">{{$t('app/pages/ResetPassword.vue:Reset your password')}}</h1>
          </div>
          ...
          <div class="max-w-sm mx-auto">
            ...
            <form>
              <div class="space-y-4">
                <div>
                  <label class="block text-sm text-slate-300 font-medium mb-1" for="email">{{$t('app/pages/ResetPassword.vue:Email')}}</label>
              ...
              <div class="mt-6">
                <button class="btn text-sm text-white bg-purple-500 hover:bg-purple-600 w-full shadow-xs group">
                  Reset Password <span class="tracking-normal text-purple-300 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">{{$t('app/pages/ResetPassword.vue:-&gt;')}}</span>
                </button>
              </div>
            </form>
