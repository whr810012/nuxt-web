  ...
  <section class="relative">
    ...
    <div class="max-w-[1440px] mx-auto px-4 md:px-0">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6 md:-mx-5">
        <img class="w-full aspect-16/10 object-cover rounded-lg" src="@/assets/images/recruitment-01.jpg" width="352" height="220" alt="Recruitment 01" />
        <img class="w-full aspect-16/10 object-cover rounded-lg" src="@/assets/images/recruitment-02.jpg" width="352" height="220" alt="Recruitment 02" />
        <img class="w-full aspect-16/10 object-cover rounded-lg" src="@/assets/images/recruitment-03.jpg" width="352" height="220" alt="Recruitment 03" />
        <img class="w-full aspect-16/10 object-cover rounded-lg" src="@/assets/images/recruitment-04.jpg" width="352" height="220" alt="Recruitment 04" />
      </div>
    </div>
      ...
      <div class="max-w-3xl mx-auto py-12 md:py-20">
        ...
        <div class="space-y-8">
          ...
          <template v-for="item in items">
            <div>
              <h4 class="inline-flex font-medium bg-clip-text text-transparent bg-linear-to-r from-purple-500 to-purple-200 pb-3">{{ item.area }}</h4>
