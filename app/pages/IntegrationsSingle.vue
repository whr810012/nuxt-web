<template>
  <div class="integration-single-page">
                      ...
                      <div class="text-center mb-5">
                        <div class="mb-4">
                          <div class="relative inline-flex">
                            <img src="@/assets/images/integrations-08.svg" width="80" height="80" alt="Icon 08" />
                            <img class="absolute top-0 -right-1" src="@/assets/images/star.svg" width="24" height="24" alt="Star" aria-hidden="true" />
                          </div>
                        </div>
